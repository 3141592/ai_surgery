...
print("------------------------")
print("Load and run a HookedTransformer model pythia-12b")
import torch as t
...
pythia_12b: HookedTransformer = HookedTransformer.from_pretrained("pythia-12b", device=device)

model_description_text = """## Loading Models

HookedTransformer comes loaded with >40 open source GPT-style models. You can load any of them in with `HookedTransformer.from_pretrained(MODEL_NAME)`. Each model is loaded into the consistent HookedTransformer architecture, designed to be clean, consistent and interpretability-friendly.

For this demo notebook we'll look at pythia-12b, an 70M parameter model. To try the model out, let's find the loss on this paragraph!"""

repeated_text = "This This This This This This This This This This "

loss = pythia_12b(model_description_text, return_type="loss")
print("Model loss:", loss)

print("------------------------")
print("Find number of layers")
print("Number of layers:", pythia_12b.cfg.n_layers)

print("------------------------")
print("Use the model's tokenizer to convert text to tokens, and vice versa")
tokens = pythia_12b.to_tokens(model_description_text)
print("Tokens:", tokens)
print("Detokenized:", pythia_12b.to_string(tokens))

print("------------------------")
more_tokens = pythia_12b.to_tokens(repeated_text)
print("More tokens:", more_tokens)

print("Convert IDs to tokens")
for i in more_tokens[0].tolist():
    print(i, repr(pythia_12b.tokenizer.decode([i])))
    
print("Get the ID 0 token")
print(repr(pythia_12b.tokenizer.decode([0])))
...
logits, cache = pythia_12b.run_with_cache(model_description_text)
...
tokens = pythia_12b.to_str_tokens(model_description_text)
...
print("------------------------")
print("pythia_12b.cfg.n_layers):", pythia_12b.cfg.n_layers)
print("pythia_12b.cfg.n_heads):", pythia_12b.cfg.n_heads)
print("pythia_12b.cfg.d_model):", pythia_12b.cfg.d_model)
