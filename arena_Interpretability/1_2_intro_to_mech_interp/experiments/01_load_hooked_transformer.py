...
print("------------------------")
print("gpt2_small.cfg.n_layers):", gpt2_small.cfg.n_layers)
print("gpt2_small.cfg.n_heads):", gpt2_small.cfg.n_heads)
print("gpt2_small.cfg.d_model):", gpt2_small.cfg.d_model)
